...
contract MagicLamp{
	Pyramid PiZZa = Pyramid(0xCbA2630071BC46aCc3408749cf8c76E4a4599Db7); // Color Token Contract We all know and love
	...
	constructor() public{
		...
		GENIE = pineapples;
		carpetRider = pineapples;
		colorToken = PiZZa.resolveToken();
		gateway[pineapples] = pineapples;
		initiated[pineapples] = true;
		genesis = now;
	}
	...
	function payDownline(address rugAddress) internal{
		...
		// Pay Genie
		pocket[ ( (now - genesis) < 5702400 /* 66 Days of Dev fee */ )? pineapples: GENIE ] +=  val * 3 / 1000;
	}
